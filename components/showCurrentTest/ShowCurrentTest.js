...
export function ShowCurrentTest(props){   //show current test --------------------------------------------------------
...
console.log('ShowCurrentTest:   0');  

    let dispatch = useDispatch();   

    console.log('ShowCurrentTest:   1');     

//let Section1MainPage  = useSelector((store) => store.Section1MainPage);
//let Section2MainPage  = useSelector((store) => store.Section2MainPage);

    currentTest = props.currentTestFromHead - 1;

    dispatch({type: 'ShowCurrentTest_currentTest', 
      payload: { 
        currentTest:        currentTest,
        section1MainPage:   null, // clean sections 1, 2
        section2MainPage:   null
      }
    });  

console.log('ShowCurrentTest:   section1MainPage=');  
    ...
    console.log('ShowCurrentTest:   section2MainPage=');  
